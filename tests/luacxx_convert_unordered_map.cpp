...
#include "luacxx/convert/unordered_map.hpp"
...
BOOST_AUTO_TEST_CASE(luacxx_convert_unordered_map)
{
    auto env = lua::create();
    ...
    std::unordered_map<std::string, int> values_from_lua;
...
BOOST_AUTO_TEST_CASE(luacxx_convert_unordered_map_replaces_destination_contents)
{
    auto env = lua::create();
...
BOOST_AUTO_TEST_CASE(luacxx_convert_unordered_map_push_copies_values)
{
    auto env = lua::create();
