...
int luaopen_luacxx_libinput(lua_State* const state)
{
    ...
    env["LIBINPUT_KEYBOARD_KEY_STATE_PRESSED "] = LIBINPUT_KEYBOARD_KEY_STATE_PRESSED ;
    env["LIBINPUT_KEYBOARD_KEY_STATE_RELEASED"] = LIBINPUT_KEYBOARD_KEY_STATE_RELEASED;
    ...
    env["LIBINPUT_POINTER_AXIS_HORIZONTAL_SCROLL "] = LIBINPUT_POINTER_AXIS_HORIZONTAL_SCROLL ;
    env["LIBINPUT_POINTER_AXIS_VERTICAL_SCROLL"] = LIBINPUT_POINTER_AXIS_VERTICAL_SCROLL;
    ...
    env["libinput_event"] = libinput_event;
    env["libinput_udev_create_for_seat"] = libinput_udev_create_for_seat;
